...
internal class Hmac(
    ...
    private val trimmedSignature: String = signature.replace("^[a-z0-9]*=([0-9a-f]{40})$".toRegex()) { it.groupValues[1] }
    ...
    internal fun verify() = (trimmedSignature == calculatedSignature).takeIf { it }
            ?: throw IllegalStateException("Signatures does not match")
}
